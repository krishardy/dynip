# -*- coding: utf-8 -*-
#
# DynIP documentation build configuration file, created by
...
latex_documents = [
  ('index', 'DynIP.tex', u'DynIP Documentation',
   u'Kris Hardy', 'manual'),
]
...
man_pages = [
    ('index', 'dynip', u'DynIP Documentation',
     [u'Kris Hardy'], 1)
]
